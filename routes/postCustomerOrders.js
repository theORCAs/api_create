                        ...
                        e.orderDetails.forEach((od) => {
                            ...
                            if (invIndex === -1) {
                                ...
                                if (inventories[invIndex].details.amount < od.quantity) {
                                    throw `Our stock quantity is lower than order quantity. Please order lower than stock quantity. 
                                    Stock quantity=${inventories[invIndex].details.amount} and order quantity=${od.quantity}`; // break
                                } else {
